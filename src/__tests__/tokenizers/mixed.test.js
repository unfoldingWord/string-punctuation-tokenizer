...
describe('mixed', () => {
  const text =
  `“Didn’t κατ’ ἐφ’ David's and Moses' 10,000 בַּ⁠חֹ֨דֶשׁ֙ abençoando-os` +
  ...
  const tests = [
    {
      ...
      expected: ["Didn", "t", "κατ", "ἐφ", "David", "s", "and", "Moses", "10", "000", "בַּ⁠חֹ֨דֶשׁ֙", "abençoando", "os", "our", "3", "inch", "h", "e", "a", "rt", "s", "burn", "7½", "disciples", "and", "everyone", "else", "what", "us", "Luke", "2", "4", "3", "2"],
    },
    {
